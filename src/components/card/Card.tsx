...
const Card = ({ artist, song, date, youtubeId }: Video) => (
    <a href={`https://www.youtube.com/watch?v=${youtubeId}`} >
        <div style={{
            ...
            <iframe width="560" height="315" src={`https://www.youtube.com/embed/${youtubeId}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
        </div>
    </a>
);
