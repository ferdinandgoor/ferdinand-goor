  ...
  return (
    ...
    >
      <p className="cookie-consent__copy">
        <strong className="cookie-consent__title">Mesure d’audience</strong>
        <span className="cookie-consent__description">
          J’utilise Google Analytics pour comprendre quelles pages sont
          consultées et améliorer le site.
        </span>
      </p>
      <div className="cookie-consent__actions">
        ...
        <ActionButton type="button" onClick={() => choose(true)}>
          Accepter
        </ActionButton>
      </div>
    </aside>
