  ...
  return (
    <main className="clip-page films-seo" id="main-content">
      ...
      <section className="films-seo__hero">
        ...
        <Container className="films-seo__hero-copy"><p className="clip-eyebrow">{page.eyebrow}</p><h1>{page.h1}</h1><p>{page.intro}</p><div className="clip-actions"><ContactLink>Parler de mon clip</ContactLink><ActionLink href="#realisations" icon={<ArrowRight />}>Voir les réalisations</ActionLink></div><small>Clips à partir de 850 € · Déplacements partout en France</small></Container>
      </section>
